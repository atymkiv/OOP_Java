...
public class Util9 {
    ...
    static Object[] array;
    static Container<String> sentences;
    ...
    public static void usersRequest() {
        ...
        while (!request.equals(EXIT)) {
            ...
            if (request.equals(INFO)) {
                ...
                command = sc.nextLine();
                String text = Utility8.outputForLab9("abba.");
                sentences = new Container<>();
                sentences.add(text);
    ...
    public static void readObjectFromFile() throws IOException{
        ...
        try {
            sentences = (Container<String>) objectInputStream.readObject();
